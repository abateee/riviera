...
export function StickyCallBar({ settings }: StickyCallBarProps) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white/95 px-4 py-3 shadow-[0_-10px_30px_-20px_rgba(15,23,42,0.5)] backdrop-blur lg:hidden">
      <a
