      ...
      <div className="section-shell grid gap-10 lg:grid-cols-[0.84fr_1.16fr]">
        <div>
          <SectionHeading
            ...
            description="Si vous préférez laisser une demande, le formulaire ci-contre reste disponible pour organiser un premier échange. Sur demande, nous accompagnons aussi les personnes en situation de handicap. Tous nos intervenants sont diplômés d'État."
          />
